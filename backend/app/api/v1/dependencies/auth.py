...
require_moh = require_roles(UserRole.MOH, UserRole.MOH_ANALYST, UserRole.SUPER_ADMIN)
require_clinician = require_roles(UserRole.CLINIC, UserRole.CLINICIAN, UserRole.FACILITY_ADMIN, UserRole.SUPER_ADMIN)
require_ngo = require_roles(UserRole.NGO, UserRole.NGO_ANALYST, UserRole.MOH, UserRole.MOH_ANALYST, UserRole.SUPER_ADMIN)
